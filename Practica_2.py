...
# S = rng.choice(valores, size=(3,3), replace=True) #Escoge valores aleatorios de una vector dado para establecer una matriz n x n
# print(S)
# print()
...
V = rng.choice(ids, size=10, replace=False) #Para el size se puede hacer con vector o plano
print(V)
